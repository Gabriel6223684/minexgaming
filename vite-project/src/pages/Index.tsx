...
export default function Index() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-primary/5">
      ...
      <section className="container mx-auto px-4 py-20 md:py-32">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-foreground/70 mb-8 leading-relaxed">
            CodeNet is the ultimate networking platform designed specifically
            for programmers. Find collaborators, share projects, learn from
            peers, and grow your professional network in a community built by
      ...
      <section
        id="features"
        className="bg-card/50 border-y border-border py-20"
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-foreground/60 text-lg">
              Build meaningful connections and accelerate your development
              journey
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-background rounded-xl border border-border p-6 hover:border-primary/50 transition group">
              ...
              <p className="text-foreground/60">
                Find developers with matching skills, interests, and project
                goals. Our algorithm connects you with the right people.
              </p>
            </div>
            ...
            <div className="bg-background rounded-xl border border-border p-6 hover:border-accent/50 transition group">
              ...
              <p className="text-foreground/60">
                Communicate instantly with potential collaborators. Share ideas,
                discuss projects, and build relationships in real-time.
              </p>
            </div>
            ...
            <div className="bg-background rounded-xl border border-border p-6 hover:border-primary/50 transition group">
              ...
              <p className="text-foreground/60">
                Display your portfolio and projects. Get discovered by potential
            ...
            <div className="bg-background rounded-xl border border-border p-6 hover:border-accent/50 transition group">
              ...
              <p className="text-foreground/60">
                Seamlessly connect your GitHub profile. Let others see your
            ...
            <div className="bg-background rounded-xl border border-border p-6 hover:border-primary/50 transition group">
              ...
              <p className="text-foreground/60">
                Tag your expertise in technologies, frameworks, and
                methodologies. Get recommended based on your skills.
              </p>
            </div>
            ...
            <div className="bg-background rounded-xl border border-border p-6 hover:border-accent/50 transition group">
              ...
              <p className="text-foreground/60">
                Request code reviews from experienced developers. Share
                knowledge and improve code quality together.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-foreground/60">
                  Sign up and set up your developer profile. Add your skills,
                  interests, and connect your GitHub account.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-foreground/60">
                  Browse the community, search by skills and interests, and find
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-foreground/60">
                  Connect with other developers, join projects, share ideas, and
                  grow your network together.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-foreground/60 mb-8">
              Be part of a vibrant community where developers collaborate,
              learn, and build amazing things together. Whether you're looking
              for your next project, learning opportunity, or just want to
              expand your network, CodeNet is the place to be.
            </p>
            <button className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-3 rounded-lg font-semibold transition transform hover:scale-105">
              Start Your Journey
            </button>
      ...
      <footer className="border-t border-border bg-background/50 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="border-t border-border pt-8 text-center text-sm text-foreground/60">
            <p>
              &copy; 2024 CodeNet. All rights reserved. Built by developers, for
              developers.
            </p>
          </div>
        </div>
